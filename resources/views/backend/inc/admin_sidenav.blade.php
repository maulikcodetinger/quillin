        ...
        <div class="aiz-side-nav-wrap">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('withdraw_requests_all') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Payout History') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
            ...
            <!-- Staffs -->
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('25', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="{{route('hsn.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['hsn.index', 'hsn.create'])}}">
                            <i class="las la-wrench aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{'HSN Manage'}}</span>
                        </a>
                    </li>
                @endif
