...
<style> 
option:checked {
  background: rgb(230, 46, 4) linear-gradient(0deg, rgb(230, 46, 4) 0%, rgb(230, 46, 4) 50%);
}
</style>
...
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('seller.products.next.upload')}}" method="POST" enctype="multipart/form-data" id="choice_form">
